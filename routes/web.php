...
Route::middleware('auth')->group(function () {
    ...
    // Route::get('/trees/{tree}', App\Livewire\Tree\TreeShow::class)->name('tree.show'); // Moved out
    // Route::get('/trees/{tree}/person/{person}', PersonShow::class)->name('person.show'); // Moved out
