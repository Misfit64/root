<div class="p-4 border rounded bg-white dark:bg-gray-800 dark:border-gray-700 space-y-4">
    ...
    <div class="mb-4">
        ...
        <select wire:model="otherParentId" class="w-full border-gray-300 dark:border-gray-600 dark:bg-gray-700 dark:text-white rounded-md shadow-sm focus:border-blue-500 focus:ring-blue-500">
